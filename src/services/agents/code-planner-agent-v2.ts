...
- Use ONLY read-only tools to gather context:
  ...
  - callAgentV2 with context-gatherer - Complex analysis
- Use AskUserQuestions if you need clarification
- You can use multiple \`Context Gatherer\` agent to concurrently collect context from multiple different modules.
