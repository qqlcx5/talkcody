...
describe('convertMessages', () => {
  ...
  describe('exploratory tool filtering', () => {
    it('should filter out glob messages', async () => {
      const messages: UIMessage[] = [
        {
          id: '1',
          role: 'user',
      ...
      // Should only have system and user (tool messages filtered)
      expect(result.length).toBe(2);
      expect(result[0].role).toBe('system');
      expect(result[1].role).toBe('user');
    });

    it('should filter out listFiles messages', async () => {
      const messages: UIMessage[] = [
        {
          id: '1',
          role: 'user',
    ...
    it('should filter out codeSearch messages', async () => {
      const messages: UIMessage[] = [
        {
          id: '1',
          role: 'user',
    ...
    it('should NOT filter non-exploratory tools', async () => {
      const messages: UIMessage[] = [
        {
          id: '1',
          role: 'user',
